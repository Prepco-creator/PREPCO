...
const Card: React.FC<CardProps> = ({ title, icon, content, className, hClassName }) => {
  return (
    <section className={`${className} rounded-3xl flex flex-col items-center justify-center gap-4 lg:gap-8 p-7 text-center bg-custom-gradient shadow-double-inset text-primaryLight`}>
